...
Where there have been significant changes and we want the full gamut of CI testing to be run on real Azure Infrastucture - then the Develop branch is used.
