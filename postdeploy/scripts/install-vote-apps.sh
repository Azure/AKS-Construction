...
helm upgrade --namespace agic-public --create-namespace --install avote-public https://github.com/Gordonby/minihelm/raw/main/samples/AzureVote-0.9.5.tgz --set ingress.enabled=true,ingress.appGwPrivateIp=false,front.service.azureLbInternal=false,front.service.type="ClusterIP"
