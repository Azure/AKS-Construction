...
[IdentityForByo.bicep](identityforbyo.bicep) | When creating a staged deployment with an existing Managed Identity, this configuration demonstrates how to pass the BYO Identity into AKS-Construction.
