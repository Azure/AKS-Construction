...
export var CommandBarButtonStyles = function (theme) {
    ...
    return {
        ...
        root: __assign(__assign({}, getFocusStyle(theme, { inset: 2 })), { fontSize: theme.fonts.medium.fontSize, backgroundColor: semanticColors.bodyBackground, color: extendedSemanticColors.commandBarButtonText, paddingLeft: 4, paddingRight: 4 }),
        rootExpanded: {
