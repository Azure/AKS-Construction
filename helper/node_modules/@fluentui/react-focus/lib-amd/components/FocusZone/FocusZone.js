        ...
        FocusZone.prototype.focus = function (forceIntoFirstElement, bypassHiddenElements) {
            ...
            if (this._root.current) {
                if (!forceIntoFirstElement &&
                    ...
                    (!bypassHiddenElements || utilities_1.isElementVisibleAndNotHidden(this._activeElement))) {
                    this._activeElement.focus();
                    return true;
                }
                else {
                    var firstChild = this._root.current.firstChild;
                    return this.focusElement(utilities_1.getNextElement(this._root.current, firstChild, true, undefined, undefined, undefined, undefined, undefined, bypassHiddenElements));
                }
            }
            return false;
        };
