...
var List = /** @class */ (function (_super) {
        ...
        for (var itemIndex = startIndex; itemIndex < endIndex; itemIndex += itemsPerPage) {
            ...
            if (requestedIndexIsInPage) {
                ...
                if (measureItem && this._scrollElement) {
                    ...
                    var scrollPosition = scroll_1.getScrollYPosition(this._scrollElement);
                    var scrollWindow = {
                        top: scrollPosition,
                    ...
                    switch (scrollToMode) {
                        case List_types_1.ScrollToMode.top:
                            scroll_1.setScrollYPosition(this._scrollElement, scrollTop);
                            return;
                        case List_types_1.ScrollToMode.bottom:
                            scroll_1.setScrollYPosition(this._scrollElement, scrollBottom - scrollRect.height);
                            return;
                        case List_types_1.ScrollToMode.center:
                            scroll_1.setScrollYPosition(this._scrollElement, (scrollTop + scrollBottom - scrollRect.height) / 2);
                            return;
    ...
    List.prototype._updateRenderRects = function (props, state, forceUpdate) {
        ...
        var scrollHeight = scroll_1.getScrollHeight(this._scrollElement);
        var scrollTop = scroll_1.getScrollYPosition(this._scrollElement);
