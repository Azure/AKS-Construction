...
var useSlider = function (props, ref) {
    ...
    var _j = react_hooks_1.useSetTimeout(), setTimeout = _j.setTimeout, clearTimeout = _j.clearTimeout;
    ...
    var _k = react_hooks_1.useControllableValue(props.value, props.defaultValue, function (ev, v) {
    ...
    var _l = react_hooks_1.useControllableValue(props.lowerValue, props.defaultLowerValue, function (ev, lv) { return onChange === null || onChange === void 0 ? void 0 : onChange(internalState.latestValue, [lv, internalState.latestValue], ev); }), unclampedLowerValue = _l[0], setLowerValue = _l[1];
    ...
    var sliderBoxProps = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ id: id, className: utilities_1.css(classNames.slideBox, buttonProps.className) }, (!disabled && {
        ...
        utilities_1.getNativeProps(buttonProps, utilities_1.divProperties, ['id', 'className']))), (!ranged && tslib_1.__assign(tslib_1.__assign({}, sliderProps), { 'aria-valuemin': min, 'aria-valuemax': max, 'aria-valuenow': value, 'aria-valuetext': getAriaValueText(value), 'aria-label': ariaLabel || label, 'aria-labelledby': ariaLabelledBy })));
