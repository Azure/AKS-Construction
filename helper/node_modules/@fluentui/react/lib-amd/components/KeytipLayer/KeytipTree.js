define(["require", "exports", "tslib", "../../Utilities", "../../utilities/keytips/KeytipUtils", "../../utilities/keytips/KeytipConstants"], function (require, exports, tslib_1, Utilities_1, KeytipUtils_1, KeytipConstants_1) {
    ...
    var KeytipTree = /** @class */ (function () {
        ...
        KeytipTree.prototype.getExactMatchedNode = function (keySequence, currentKeytip) {
            ...
            var fullKeySequences = overflowSetSequence ? KeytipUtils_1.mergeOverflows(keySequences, overflowSetSequence) : keySequences;
            var keytipTargetSelector = KeytipUtils_1.ktpTargetFromSequences(fullKeySequences);
