    ...
    var ScrollablePaneBase = /** @class */ (function (_super) {
        ...
        function ScrollablePaneBase(props) {
            ...
            _this._getStickyContainerStyle = function (height, isTop) {
                return tslib_1.__assign(tslib_1.__assign({ height: height }, (Utilities_1.getRTL(_this.props.theme)
                    ? {
                        right: '0',
        ...
        ScrollablePaneBase.prototype.render = function () {
            ...
            return (React.createElement("div", tslib_1.__assign({}, Utilities_1.getNativeProps(tslib_1.__assign({}, this.props), Utilities_1.divProperties, 
