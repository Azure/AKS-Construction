define(["require", "exports", "tslib", "react", "../../Styling", "../../Utilities", "../../Color", "../../utilities/ButtonGrid/ButtonGridCell", "../Button/ActionButton/ActionButton.styles"], function (require, exports, tslib_1, React, Styling_1, Utilities_1, Color_1, ButtonGridCell_1, ActionButton_styles_1) {
    ...
    var ColorPickerGridCellBase = function (props) {
        ...
        var onRenderColorOption = function (colorOption) {
            ...
            return (React.createElement("svg", { className: svgClassName, role: "img", "aria-label": colorOption.label, viewBox: "0 0 20 20", fill: (_a = Color_1.getColorFromString(colorOption.color)) === null || _a === void 0 ? void 0 : _a.str }, circle ? React.createElement("circle", { cx: "50%", cy: "50%", r: "50%" }) : React.createElement("rect", { width: "100%", height: "100%" })));
        };
