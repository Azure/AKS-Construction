define(["require", "exports", "tslib", "react", "../../Utilities", "../../Icon", "../../FocusZone", "./Rating.types", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, Utilities_1, Icon_1, FocusZone_1, Rating_types_1, react_hooks_1) {
    ...
    exports.RatingBase = React.forwardRef(function (props, forwardedRef) {
        ...
        return (React.createElement("div", tslib_1.__assign({ ref: mergedRootRefs, className: Utilities_1.css('ms-Rating-star', classNames.root, rootSizeClass), "aria-label": !readOnly ? normalModeAriaLabel : undefined, id: id, role: !readOnly ? 'radiogroup' : undefined }, divProps),
