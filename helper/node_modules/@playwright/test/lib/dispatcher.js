...
class Dispatcher {
  constructor(loader, testGroups, reporter) {
    ...
    this._finished = new _manualPromise.ManualPromise();
  ...
  async _runJob(worker, testGroup) {
    ...
    const onWatchTestResolved = params => {
      const test = new _test.TestCase(params.title, () => {}, new _testType.TestTypeImpl([]), params.location);
      this._testById.set(params.testId, {
        test,
        resultByWorkerIndex: new Map()
      });
    };
    ...
    const onTestBegin = params => {
      ...
      (_this$_reporter$onTes = (_this$_reporter = this._reporter).onTestBegin) === null || _this$_reporter$onTes === void 0 ? void 0 : _this$_reporter$onTes.call(_this$_reporter, data.test, result);
    };
    ...
    const onDone = params => {
        ...
        remaining = remaining.filter(test => {
          ...
          if (!this._hasReachedMaxFailures()) {
            ...
            if (runData) {
              ...
              (_this$_reporter$onTes2 = (_this$_reporter5 = this._reporter).onTestBegin) === null || _this$_reporter$onTes2 === void 0 ? void 0 : _this$_reporter$onTes2.call(_this$_reporter5, test, result);
            }
      ...
      if (params.fatalUnknownTestIds) {
        ...
        massSkipTestsFromRemaining(new Set(params.fatalUnknownTestIds), [{
          message: `Unknown test(s) in worker:\n${titles.join('\n')}`
        }]);
      }
      ...
      remaining = remaining.filter(test => {
        var _this$_reporter$onTes3, _this$_reporter7;
        ...
        (_this$_reporter$onTes3 = (_this$_reporter7 = this._reporter).onTestBegin) === null || _this$_reporter$onTes3 === void 0 ? void 0 : _this$_reporter$onTes3.call(_this$_reporter7, test, result);
    ...
    const onExit = data => {
      const unexpectedExitError = data.unexpectedly ? {
        value: `Worker process exited unexpectedly (code=${data.code}, signal=${data.signal})`
      } : undefined;
      onDone({
  ...
  _createWorker(hash, parallelIndex) {
    ...
    worker.on('stdOut', params => {
      ...
      (_this$_reporter$onStd2 = (_this$_reporter8 = this._reporter).onStdOut) === null || _this$_reporter$onStd2 === void 0 ? void 0 : _this$_reporter$onStd2.call(_this$_reporter8, chunk, test, result);
    });
    worker.on('stdErr', params => {
      ...
      (_this$_reporter$onStd3 = (_this$_reporter9 = this._reporter).onStdErr) === null || _this$_reporter$onStd3 === void 0 ? void 0 : _this$_reporter$onStd3.call(_this$_reporter9, chunk, test, result);
    });
    worker.on('teardownErrors', params => {
      this._hasWorkerErrors = true;
      for (const error of params.fatalErrors) {
        var _this$_reporter$onErr2, _this$_reporter10;
        (_this$_reporter$onErr2 = (_this$_reporter10 = this._reporter).onError) === null || _this$_reporter$onErr2 === void 0 ? void 0 : _this$_reporter$onErr2.call(_this$_reporter10, error);
      }
    });
    return worker;
  }
  ...
  _reportTestEnd(test, result) {
    ...
    (_this$_reporter$onTes4 = (_this$_reporter11 = this._reporter).onTestEnd) === null || _this$_reporter$onTes4 === void 0 ? void 0 : _this$_reporter$onTes4.call(_this$_reporter11, test, result);
    const maxFailures = this._loader.fullConfig().maxFailures;
...
class Worker extends _events.EventEmitter {
  constructor(hash, parallelIndex, workerIsolation) {
    super();
    this.process = void 0;
    this._hash = void 0;
