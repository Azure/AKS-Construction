...
export default function PortalNav({ config }) {
  ...
  invalidFn('addons', 'ingress', cluster.osType === "Windows" && addons.ingress !== "appgw" && addons.ingress !== "none", 'Neither the Windows nodepool or the system pool will not be able to run your selected Ingress Controller. To support this Ingress Controller, add another linux nodepool post cluster creation.')
