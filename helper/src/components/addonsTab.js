        ...
        <Stack tokens={{ childrenGap: 15 }} styles={adv_stackstyle}>
            ...
            { addons.monitor === "aci" &&
                <Stack.Item align="center" styles={{ root: { maxWidth: '700px'}}}>
                    ...
                    <MessageBar messageBarType={MessageBarType.warning}>Enabling Basic Logs for ContainerLogsV2 has a dependency on the ContainerLogsV2 schema and thus enabling this capability will automatically enable ContainerLogsV2. In addition, the ContainerLogsV2 table's retention is fixed at eight days. More information available via the provided docs link.</MessageBar>
